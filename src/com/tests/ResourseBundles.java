...
public enum ResourseBundles {
    MESSAGES_EN(ResourceBundle.getBundle("com.resources.Messages_Bundle",  new Locale("en", "US"))),
    MESSAGES_RU(ResourceBundle.getBundle("com.resources.Messages_Bundle", new Locale("ru", "RU"))),
    GUI_EN(ResourceBundle.getBundle("com.resources.GUI_Bundle", new Locale("en", "US"))),
    GUI_RU(ResourceBundle.getBundle("com.resources.GUI_Bundle", new Locale("ru", "RU"))),
    EXCEPTIONS_EN(ResourceBundle.getBundle("com.resources.Exception_Bundle", new Locale("en", "US"))),
