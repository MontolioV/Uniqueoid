...
public class ResourcesProvider {
    ...
    public void setBundlesLocale(Locale locale) {
        ...
        ResourceBundle exceptionsBundle = ResourceBundle.getBundle("io.sourceforge.uniqueoid.bundles.Exception_Bundle", locale);
        ResourceBundle guiBundle = ResourceBundle.getBundle("io.sourceforge.uniqueoid.bundles.GUI_Bundle", locale);
        ResourceBundle messagesBundle = ResourceBundle.getBundle("io.sourceforge.uniqueoid.bundles.Messages_Bundle", locale);
